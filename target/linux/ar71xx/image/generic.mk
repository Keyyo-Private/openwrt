...
define Device/ak100w
  DEVICE_TITLE := AK100w (Compex MMZ563HV) (16MB flash)
  BOARDNAME := WPJ563
  ...
  MTDPARTS := spi0.0:192k(u-boot)ro,13952k(firmware),2048k(kros),64k(otp)ro,64k(nvram)ro,64k(art)ro
  IMAGE_SIZE := 14080k
endef
TARGET_DEVICES += ak100w
